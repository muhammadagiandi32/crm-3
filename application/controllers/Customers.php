...
class Customers extends CI_Controller
{
    ...
    public function tambah_customers()
    {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $dariDB = $this->Customers_model->cekkodecustomer();
            $nourut = substr($dariDB, 3, 4);
            $kodeCustomerSekarang = $nourut + 1;
            $data = array('kode_customers' => $kodeCustomerSekarang);
            ...
            $data = [
                'id_customers'   => null,
                'kode_customers' => htmlspecialchars($this->input->post('kode')),
