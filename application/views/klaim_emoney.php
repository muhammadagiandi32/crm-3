        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Klaim E - Money</a></li>
    ...
    <section class="content">
      ...
      <div class="card">
        <div class="card-header">
          <h3 class="card-title">Klaim E - Money</h3>
        ...
        <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Input Klaim E - Money</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form action="<?= base_url('Klaim/insert_emoney') ?>" method="POST">
                <div class="card-body">
                  ...
                  <div class="form-group">
                    <label for="exampleInputEmail1">Biaya Tol E - Money</label>
                    <input type="text" name="biaya_tol" class="form-control" id="exampleInputEmail1" placeholder="Biaya Tol E - Money">
                  </div>
                  <div class="form-group">
                    <label for="exampleInputEmail1">Parkir E - Money</label>
                    <input type="text" name="parkir" class="form-control" id="exampleInputEmail1" placeholder="Parkir E - Money">
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" name="status" value="E-Money" class="form-control" id="exampleInputEmail1" placeholder="Keterangan" readonly>
                  </div>
