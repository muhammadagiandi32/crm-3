...
<body>
    <div class="box" id="printJS-table">
        ...
        <div>
            <div class="back">
                <img src="" alt="">
                <img class="images" src="<?= base_url ('img/rusmanjaya1.png')?>" alt="">
                <p class="head1">RUSMAJAYA</p> 
            </div>
            <div>
            ...
            <div class="margin">
                <div id="penutup">
                    <div id="garisbawah1">No. </div>
                </div>
                <div id="penutup">
                    <div id="garisbawah">Telah Terima Dari:</div>
                    <div></div>
                </div>
                <div id="penutup">
                    <div id="garisbawah">Uang Sejumlah:</div>
                </div>
                <div id="penutup">
                    <div id="garisbawah">Untuk Pembayaran:</div>
                    <!-- <div>Inv. </div> -->
                </div>
                <div class="garisvertical"></div>
            </div>
        </div>
        <div id="jumlah">Rp. </div>

        <div id="tanggal">Jakarta, </div>
